...
public class Adapter_Switch extends RecyclerView.Adapter {
    ...
    public void switchStyle(boolean type) {
        this.type = type;
    }

    public Adapter_Switch(Context context, List<String> datas) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == 0) {
            return new GridHolder(layoutInflater.inflate(R.layout.recy_horizontal, parent, false));
        } else if (viewType == 1) {
